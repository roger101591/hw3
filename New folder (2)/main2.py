...
Winner_Percent = max(Vestal_Percent,Torres_Percent,Seth_Percent,Cordin_Percent,Khan_Percent,Correy_Percent,Li_Percent,OTooley_Percent)
...
if Winner_Percent == Vestal_Percent:
    ...
    print("Winner: " + "Torres")
elif Winner_Percent == Seth_Percent:
    print("Winner: " + "Seth")
elif Winner_Percent == Cordin_Percent:
    print("Winner: " + "Cordin")
elif Winner_Percent == Khan_Percent:
    print("Winner: " + "Khan")
elif Winner_Percent == Correy_Percent:
    print("Winner: " + "Correy")
elif Winner_Percent == Li_Percent:
    print("Winner: " + "Li")
else: print("Winner: " + "O\'Tooley")
